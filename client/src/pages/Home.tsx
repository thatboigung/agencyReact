...
import { ArrowRight, Zap, TrendingUp, Award, Palette, BarChart3, Camera, Code2, Globe, Layout, Calendar } from "lucide-react";
    ...
    <div className="min-h-screen bg-background selection:bg-primary/30">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="container relative z-10 px-6 text-center">
          ...
          >
            Stand Out in Your Market & <span className="text-primary">Win More Customers</span>
          </motion.h1>
          ...
          >
            Get Recognized | Attract Attention | Drive Growth | Convert Sales
          </motion.p>
      ...
      <section className="py-24 bg-zinc-950/50">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-white/60">Real results that impact your bottom line and accelerate your growth.</p>
          </div>
